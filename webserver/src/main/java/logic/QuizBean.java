...
public class QuizBean {
    ...
    private static String ANSWER_SPLIT_REGEX = "[-]";
    private static String FIRE_BASE_URL = "https://test-1ae31.firebaseio.com/";
    ...
    public List<Player> getScoreTable(){
        ...
        for (Map.Entry entryPlayer : playersMap.entrySet()) {
            ...
            for (Map.Entry entry : user.entrySet()) {
                ...
                String sq = entry.getKey().toString().split(ANSWER_SPLIT_REGEX)[1];
